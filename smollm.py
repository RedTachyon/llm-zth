...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, n_embd: int, n_head: int, bias: bool, dropout: float = 0.0):
        super().__init__()
...
class GPT(nn.Module):
    ...
    def __init__(self, vocab_size: int, block_size: int, n_layer: int, n_embd: int, n_head: int, bias: bool,
                 dropout: float):
        super().__init__()
